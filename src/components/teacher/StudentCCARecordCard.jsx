...
export default function StudentCCARecordCard({ cca, onClick, studentName, studentClass, studentEmail }) {
  return (
    <div
    ...
    >
      ...
      <div className="mb-2 relative z-10">
        <div className="font-bold text-slate-700 text-base">{studentName}</div>
        <div className="text-xs text-slate-400">{studentClass} &bull; {studentEmail}</div>
      </div>
      {/* CCA Info */}
