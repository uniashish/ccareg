...
export default function VendorToolbar({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 md:p-5 flex flex-col md:flex-row md:items-center gap-3 md:gap-4">
      {ccas.length > 1 && (
      ...
      <div className="relative" ref={exportRef}>
        <button
          ...
          disabled={!canExport}
          className={`px-4 py-2.5 rounded-xl border font-bold text-sm transition-colors inline-flex items-center gap-2 ${
            canExport
